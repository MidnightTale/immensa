package th.in.midnight_network.immensa.client;

import th.in.midnight_network.immensa.world.WorldScaleManager;
import th.in.midnight_network.immensa.world.WorldScaleSelectionState;
...
public final class WorldScaleSettingsScreen extends Screen {
    private static final String MOD_ID = "immensa";
    ...
    public WorldScaleSettingsScreen(Screen parentScreen) {
        super(Component.translatable("immensa.world_settings.title"));
    ...
    private void applyWorldHeightForScale(int selectedScale) {
        ...
        createWorldScreen.getUiState().updateDimensions((registryManager, selectedDimensions) -> {
            WorldDimensions updatedDimensions =
                    updateOverworldDimensionType(registryManager.registryOrThrow(Registries.DIMENSION_TYPE),
    ...
    private WorldDimensions updateOverworldDimensionType(
        ...
        ResourceLocation dimensionTypeId = ResourceLocation.fromNamespaceAndPath(MOD_ID, "terrain_diffusion_scale_" + selectedScale);
        Holder.Reference<DimensionType> selectedDimensionTypeEntry = dimensionTypeRegistry.getHolder(dimensionTypeId).orElse(null);
        ...
        Map<net.minecraft.resources.ResourceKey<LevelStem>, LevelStem> updatedDimensionMap =
