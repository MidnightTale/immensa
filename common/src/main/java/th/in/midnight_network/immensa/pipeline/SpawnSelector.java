...
import th.in.midnight_network.immensa.world.HeightConverter;
...
public final class SpawnSelector {
    ...
    public static BlockPos findSpawnBlockPos() {
        int initialSize = ImmensaConfig.spawnSearchInitialSize();
        int maxSize = ImmensaConfig.spawnSearchMaxSize();
